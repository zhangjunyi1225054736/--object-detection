...
def _write_voc_results_files(json_dataset, all_boxes, salt):
    ...
    #changed
    #"image_set_path = /home/zhangdongyu/object-detection/detectron/VOC2007/ImageSets/Main/test.txt"
    #image_set_path = "/home/zhangdongyu/object-detection/detectron/VOC2007/ImageSets/Main/zjy/test.txt"
    ...
    #print("image_index_len:".len(image_index))
    ...
    for cls_ind, cls in enumerate(json_dataset.classes):
        ...
        print("all_boxes[cls_ind]",len(all_boxes[cls_ind]))
        ...
        with open(filename, 'w+') as f:
            for im_ind, index in enumerate(image_index):
                ...
                for k in range(dets.shape[0]):
                    #print("cls:",cls)
                    #print("dets[]:",dets[k, -1],dets[k, 0],dets[k, 1],dets[k, 2],dets[k, 3])
