...
source_365 = "/mnt/md126/zhangjunyi/365-object-detection/objects365_json/objects365_train.json"
...
for i in range(len(annotations)):
    #a.append(i["name"])
    c = data["annotations"][i]["category_id"]
    if int(c) in range(301,366):
       s.add(data["annotations"][i]["image_id"])

print(len(s)) 

#with open("./365_json/objects365_val.json","w") as dump_f:
